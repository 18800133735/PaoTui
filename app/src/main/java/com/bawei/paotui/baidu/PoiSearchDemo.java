package com.bawei.paotui.baidu;
...
import com.bawei.paotui.baidu.overlayutil.PoiOverlay;
...
public class PoiSearchDemo extends BaseActivity implements
    ...
    private EditText poi_ed_adress = null;
    private EditText poi_ed_adress2 = null;
    ...
    private LinearLayout poi_linear1;
    private LinearLayout poi_linear2;
    private LinearLayout poi_linear3;
...
//        地址信息
        poi_ed_adress = (EditText) findViewById(R.id.poi_ed_adress);
        poi_ed_adress2 = (EditText) findViewById(R.id.poi_ed_adress2);
//        布局控件
        poi_linear1 = (LinearLayout) findViewById(R.id.poi_linear1);
        poi_linear2 = (LinearLayout) findViewById(R.id.poi_linear2);
        poi_linear3 = (LinearLayout) findViewById(R.id.poi_linear3);
    ...
    public void OK(View v){
        adress = poi_ed_adress.getText().toString();
        adress2 = poi_ed_adress2.getText().toString();
        String drs = adress+adress2+"";

        Intent intent = new Intent();
        intent.putExtra("adress",drs);

        PoiSearchDemo.this.setResult(2,intent);
        finish();
    ...
    public void onGetPoiResult(PoiResult result) {
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            poi_linear1.setVisibility(View.INVISIBLE);

            poi_linear2.setVisibility(View.VISIBLE);
            poi_linear3.setVisibility(View.VISIBLE);
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            ...
            poi_ed_adress.setText(result.getName());
        }
    }
